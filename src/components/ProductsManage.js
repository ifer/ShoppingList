...
import { BrowserRouter as Router, withRouter, Route, Link, Prompt } from 'react-router-dom';
...
class ProductsList extends React.Component {
    ...
    openUpdProductForm() {
        if (this.selectedProdid == null) return;
    ...
    openDelProductForm() {
        ...
        let customBody = (
            <div>
                <div>{messages.deleteProductConfirmBody1}</div>
                ...
                <div>{messages.deleteProductConfirmBody2}</div>
            </div>
        );
            ...
            <div>
                ...
                >
                    <Row style={{ width: '100%', marginRight: '0px', paddingRight: '0px' }}>
                        <Col md={5}>
                            <ButtonGroup
                                bsClass="modeEditProducts-button-group"
                                hidden={this.state.mode == modeEditProducts ? false : true}
                            >
                                <Button
                                    bsStyle="success"
                                    onClick={this.openAddProductForm}
                                ...
                                <Button
                                    bsStyle="primary"
                                    onClick={this.openUpdProductForm}
                                    className="table-action-button"
                                >
                                ...
                                <Button
                                    bsStyle="danger"
                                    onClick={this.openDelProductForm}
                                    className="table-action-button"
                                >
                            ...
                            <ButtonGroup
                                bsClass="shoplist-button-group"
                                hidden={this.state.mode == modeShoplist ? false : true}
                            >
                                <Button bsStyle="primary" onClick={this.saveSelected} className="table-action-button">
                                    {messages.btnSave}
                                </Button>
                                <Button bsStyle="danger" onClick={this.unselectAll} className="table-action-button">
                                    {messages.btnClear}
                                </Button>
                                <Button bsStyle="info" onClick={this.intentToPrintList} className="table-action-button">
                                    {' '}
                                    {messages.btnPrint}
                                </Button>
                            </ButtonGroup>
                        ...
                        <Col md={3} style={{ flexDirection: 'column', display: 'flex', alignItems: 'flexCenter' }}>
                            <span>
                                <Image src={shopimg} />
                                <span style={{ marginLeft: '5px', color: 'blue' }}>{this.selected.length}</span>
                            </span>
                        </Col>
                        <Col md={1}></Col>
                        <Col
                        ...
                        >
                            <Button
                                bsStyle="default"
                                className="changemode-table-action-button"
                                onClick={this.intentToToggleMode}
                            >
                                {this.state.mode == modeEditProducts
                                    ? messages.modeShoplist
                                    : messages.modeEditProducts}
                            </Button>
                        </Col>
                    </Row>
                </Grid>
                <BootstrapTable
                    ...
                    cellEdit={this.state.mode == modeShoplist ? cellEditProp : false}
                    options={options}
                >
                    <TableHeaderColumn
                        dataField="prodid"
                    ...
                    <TableHeaderColumn
                        dataField="catid"
                        ref="catid"
                        filter={{ type: 'NumberFilter', delay: 100 }}
                        hidden
                    />
