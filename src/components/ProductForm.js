...
export default class ProductForm extends React.Component {
    constructor(props) {
        ...
        this.prodobj = null;
        this.state = { showProductForm: false, prodobj: this.prodobj };
    ...
    submit() {
        ...
        this.props.onModify(this.prodobj, this.close);
    }
    ...
    render() {
        if (this.prodobj == null) return <div />;
        ...
        for (let i = 0; i < this.props.categories.length; i++) {
            let option = (
                <option key={this.props.categories[i].catid} value={this.props.categories[i].catid}>
                    {this.props.categories[i].descr}
                </option>
            );
        ...
        return (
            <div>
                <Modal
                    id="prod"
                    show={this.state.showProductForm}
                    onHide={this.cancel}
                    keyboard={true}
                    dialogClassName=""
                >
