...
class Logout extends React.Component {
    ...
    onAuthChange(result, username) {
        ...
        this.setState({ loggedIn: result, username: username });
    }
        ...
        return this.state.loggedIn ? (
            <Navbar.Collapse>
                <Navbar.Form pullRight>
                    <FormGroup>
                        <ControlLabel className="username-label">{this.state.username}</ControlLabel>
                        <Button type="submit" bsStyle="link" bsSize="small" onClick={this.onLogoutClicked}>
                            {messages.logout}
                        </Button>
                    </FormGroup>
                    <ControlLabel className="version-label">έκδ. {appinfo.version}</ControlLabel>
                </Navbar.Form>
            </Navbar.Collapse>
        ) : (
            <div />
